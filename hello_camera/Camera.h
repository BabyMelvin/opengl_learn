...
public:
    ...
    // Accepts input paramster in the form of camera defined ENUM
    ...
    glm::mat4 calculateLookAtMatrix(glm::vec3 position, glm::vec3 target, glm::vec3 WorldUp)
    {
        ...
        // in glm we access elments as mat[col][row] due to col-major layout
        ...
        // remeber to read from right to left(first translation then totation)
